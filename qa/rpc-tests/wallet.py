...
#   c) node1 mines 32 blocks, so now node 0 has 60001nscoin, node 1 has 4250nscoin, node2 has none.
#   d) node0 sends 601 nscoin to node2, in two transactions (301 nscoin, then 300 nscoin).
