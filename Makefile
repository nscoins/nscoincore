...
pkgdatadir = $(datadir)/nscoin
pkgincludedir = $(includedir)/nscoin
pkglibdir = $(libdir)/nscoin
pkglibexecdir = $(libexecdir)/nscoin
...
CONFIG_HEADER = $(top_builddir)/src/config/nscoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/nscoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/ubuntu/nscoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/ubuntu/nscoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ubuntu/nscoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ubuntu/nscoin/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = nscoin-cli
BITCOIN_DAEMON_NAME = nscoind
BITCOIN_GUI_NAME = nscoin-qt
BITCOIN_TX_NAME = nscoin-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/ubuntu/nscoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = nscoin
PACKAGE_BUGREPORT = www.nscoin.us
PACKAGE_NAME = NsCoin Core
PACKAGE_STRING = NsCoin Core 1.1.0
PACKAGE_TARNAME = nscoin
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/ubuntu/nscoin
abs_srcdir = /home/ubuntu/nscoin
abs_top_builddir = /home/ubuntu/nscoin
abs_top_srcdir = /home/ubuntu/nscoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ubuntu/nscoin/build-aux/install-sh
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/nscoin.icns
OSX_PLIST = $(top_srcdir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/nscoin.ico \
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_nscoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_nscoin_coverage.info test_nscoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/nscoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/NsCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/nscoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/nscoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/nscoin-config.h
$(top_srcdir)/src/config/nscoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/nscoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/Resources/nscoin.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/NsCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/NsCoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/NsCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_nscoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_nscoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_nscoin_filtered.info: test_nscoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_nscoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_nscoin_coverage.info: baseline_filtered_combined.info test_nscoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_nscoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_nscoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_nscoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_nscoin.coverage/.dirstamp:  test_nscoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_nscoin.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local:
	rm -rf test_nscoin.coverage/ total.coverage/ $(OSX_APP)
