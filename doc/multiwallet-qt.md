...
In order to support loading of multiple wallets in nscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nscoin.cpp.
...
Changes to nscoin.cpp
----------------------
nscoin.cpp is the entry point into nscoin-qt, and as such, will require some minor modifications to provide hooks for
