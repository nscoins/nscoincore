...
GUIUtil::restoreWindowGeometry("nWindow", QSize(1170, 640), this);
//this->setFixedSize(1065,670);
QFontDatabase::addApplicationFont(":/fonts/nscoin_font");

QString windowTitle = tr("nscoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NSC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and NSC: URIs)"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NSC wallet"), this);
    aboutAction->setStatusTip(tr("Show information about NSC wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NSC wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NSC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/transaction_0")), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NSC addresses"));
    ...
    openAction->setStatusTip(tr("Open a NSC: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NSC help message to get a list with possible NSC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NSC client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    QIcon connectionItem = QIcon(icon).pixmap(64, 64);
    labelConnectionsIcon->setIcon(connectionItem);
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NSC network", "", count));
}
...
{
    QString strTitle = tr("NSC"); // default title
