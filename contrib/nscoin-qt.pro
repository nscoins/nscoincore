...
RESOURCES += src/qt/nscoin.qrc src/qt/nscoin_locale.qrc

TRANSLATIONS += src/qt/locale/nscoin_bg.ts \
                src/qt/locale/nscoin_de.ts \
                src/qt/locale/nscoin_en.ts \
                src/qt/locale/nscoin_es.ts \
                src/qt/locale/nscoin_fi.ts \
                src/qt/locale/nscoin_fr.ts \
                src/qt/locale/nscoin_it.ts \
                src/qt/locale/nscoin_ja.ts \
                src/qt/locale/nscoin_pl.ts \
                src/qt/locale/nscoin_pt.ts \
                src/qt/locale/nscoin_ru.ts \
                src/qt/locale/nscoin_sk.ts \
                src/qt/locale/nscoin_sv.ts \
                src/qt/locale/nscoin_vi.ts \
                src/qt/locale/nscoin_zh_CN.ts \
                src/qt/locale/nscoin_zh_TW.ts
